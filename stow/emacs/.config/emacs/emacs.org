...
At work emacs does not see all shell path by default under macos
This fixes stuff like lsp not being found
#+begin_src emacs-lisp
...
Switch theme according to system theme
Linux: current used Emacs 30.2 uses GTK3 Theme and needs e.g. [[https://extensions.gnome.org/extension/4998/legacy-gtk3-theme-scheme-auto-switcher/][Legacy GTK3 Switcher Extension]]
Mindre does not want to load on switch, but also from M-x load-theme
